            ...
            <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 md:grid-cols-2 gap-12">
                <div className="bg-black/30 p-8 rounded-lg border border-white/10 shadow-lg">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <Button type="submit" size="lg" className="rounded-full bg-gradient-to-r from-teal-500 to-fuchsia-600 text-white hover:from-teal-600 hover:to-fuchsia-700 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg group w-full px-10 py-3 text-lg">
