        ...
        <div className="space-y-12">
            ...
            return (
                ...
                >
                    ...
                    <motion.div 
                        initial={{ scale: 0 }}
                        className="cert-icon absolute top-8 left-5 -translate-x-1/2 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-card text-card-foreground shadow-lg ring-4 ring-white/20 md:static md:col-start-2 md:row-start-1 md:translate-x-0"
                    >
